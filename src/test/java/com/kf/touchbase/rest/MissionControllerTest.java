...
class MissionControllerTest {
    ...
    //        int databaseSizeBeforeCreate = missionRepository.findAll().count().blockingGet()
    //        .intValue();
    //
    //        var response = client.exchange(HttpRequest.GET("/api/v1/mission").bearerAuth
    //        (AUTHED_USER)).blockingFirst();
    //
